   ...
   <body>
         ...
         <section class="slider_section ">
           <div class="slider_bg_box mt-10" >
               <img src="<?php echo e(asset('assets/images/support.png')); ?>" alt="" style="width: 550px; height: 300px; float: right; margin: 170px 170px 20px 20px;">
            </div>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pecon\resources\views/support/view.blade.php ENDPATH**/ ?>