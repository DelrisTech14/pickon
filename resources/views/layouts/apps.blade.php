...
<head>
   ...
   <link rel="shortcut icon" href="{{asset('assets/images/battery.png')}}" type="">
      ...
      <header class="header_section">
         ...
         <div class="container">
            ...
            <nav class="navbar navbar-expand-lg custom_nav-container ">
               ...
               <a class="navbar-brand" href="{{ url('dashboard') }}"><img width="250" src="{{asset('assets/images/logo.png')}}" alt="#" /></a>
                  ...
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li><a href="{{ url('dashboard/agm') }}">AGM VRLA Batteries</a></li>

                           <li><a href="{{ url('dashboard/tub') }}">Tubular Gel Batteries</a></li>
                     ...
                     <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{ url('dashboard/about') }}">About us</a>
                     ...
                     <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{ url('dashboard/enquiry') }}">Contact us</a>
                     ...
                     <div class="col-md-6 col-lg-2">
                        ...
                        <div class="widget_menu">
                           ...
                           <ul>
                              ...
                              <li><a href="{{ url('dashboard/enquiry') }}">Contact us</a></li>
